...
if(isset($_POST["registrar"])){
    ...
    $veterinario = new Veterinario("", $nombre, $apellido, $correo, $clave, $especialidad);
		...
		<div class="col-6">
			<div class="card">
				...
				<div class="card-body">
					...
					<?php } ?>
					<form action=<?php echo "index.php?pid=" . base64_encode("presentacion/estudiante/registrarEstudiante.php")."&nos=true" ?> method="post">
						...
						<div class="form-group">
							<input type="text" name="especialidad" class="form-control" placeholder="Especialidad" required="required" value="<?php echo $especialidad; ?>">
						</div>
